						...
						<div class="shop_pagination_area wow fadeInUp"
							...
							<c:if test="${ProductsPaginate != null }">
								<ul class="pagination pagination-sm">
									...
									<li class="page-item"><a class="page-link" href="<c:url value='/brand/${ brandId }/page=1'/>">&laquo;</a>
										<c:forEach var="item" begin="1"
											end="${ paginateInfo.totalPage }" varStatus="loop">
											<c:if test="${ (loop.index) == paginateInfo.currentPage }">
												<li class="page-item active"><a class="page-link"
													href="<c:url value='/brand/${ brandId }/page=${ loop.index }'/>">${ loop.index }</a></li>
											</c:if>
											<c:if test="${ (loop.index) != paginateInfo.currentPage }">
									...
									<li class="page-item"><a class="page-link" href="<c:url value='/category/${ brandId }/page=${ paginateInfo.totalPage }'/>">&raquo;</a></li>
								</ul>
								</c:if>
							</nav>
						</div>
